...
public class BlockProfessionalUseCase {
    ...
    public BlockProfessionalUseCase(
    ...
    public AdministrativeProfessionalResponse blockProfessional(UUID professionalIdentifier) {
        ...
        return AdministrativeProfessionalResponse.fromProfessional(
                updateProfessionalPort.updateProfessional(professional.blockProfessional())
        );
    }
}

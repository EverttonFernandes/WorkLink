...
required_env: []
metadata:
  progressive_disclosure: "Leia diff, arquivos sensiveis e RNFs apenas quando houver risco de seguranca, pre-commit ou gate de continuidade."
  conditional_details: "if diff toca auth/secrets/dados/infra then auditar bloqueante; else_if pre-commit sem risco alto then checar padroes minimos; else N/A."
---

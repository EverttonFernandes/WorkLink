...
required_env: []
metadata:
  progressive_disclosure: "Leia configs Gradle e regras de arquitetura/nomes apenas quando a mudança Java exigir compilacao, estilo ou fronteiras."
  conditional_details: "if build/analyze Java falhar then diagnosticar e corrigir; else_if nome/arquitetura parecer fraco then abrir rules complementares; else reportar N/A."
---

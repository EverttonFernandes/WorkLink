...
required_env: []
metadata:
  progressive_disclosure: "Leia comandos e padroes de teste somente do modulo afetado; aprofunde em evidencias quando a historia exigir gate formal."
  conditional_details: "if comportamento Java mudou then rodar testes relevantes e coverage; else_if falha apareceu no CI/local then isolar log; else declarar teste Java N/A."
---

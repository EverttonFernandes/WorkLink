...
required_env: []
metadata:
  progressive_disclosure: "Leia RNFs operacionais e arquivos de ambiente somente quando a historia tocar CI/CD, deploy, config, observabilidade ou disponibilidade."
  conditional_details: "if mobile infra then chamar mobile-infra-specialist; else_if CI/deploy/config mudou then validar operacao; else registrar N/A operacional."
---
...
- `.agents/skills/ralph-loop/mobile-infra-specialist-agent/SKILL.md`

...
required_env: []
metadata:
  progressive_disclosure: "Leia prototipos/mapa apenas das telas impactadas; aprofunde em requisitos e screenshots quando houver UI, APK ou homologacao."
  conditional_details: "if tela Flutter mudou then comparar prototipo e responsividade; else_if artifact mobile mudou then exigir evidencia visual; else nao acionar."
---

...
required_env: []
metadata:
  progressive_disclosure: "Leia runbooks/workflows apenas do alvo Android, iOS, emulator, signing ou loja envolvido na historia."
  conditional_details: "if Android/iOS CI ou release mudou then auditar pipeline/distribuicao; else_if decisao de custo then registrar trade-off; else apoiar SRE sob demanda."
---

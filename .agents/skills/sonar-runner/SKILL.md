...
metadata:
  progressive_disclosure: "Leia configuracao Sonar somente quando o projeto estiver preparado ou a historia exigir quality gate estatico."
  conditional_details: "if Sonar configurado/token presente then executar scanner; else_if gate solicitado sem config then registrar N/A justificado; else nao acionar."
---

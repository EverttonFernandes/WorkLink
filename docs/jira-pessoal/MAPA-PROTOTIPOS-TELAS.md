...
| `docs/prototipos-de-tela/tela-verificao-usuario-cliente-profissional.png` | [WL-009](historias/WL-009-autenticacao-cliente-telefone.md)     | Escolha/identificação de perfil para fluxo autenticado            | RF14, RF15, RF16, RF17, RN01, RN02                   | QA, mobile, segurança, privacidade                                |
| `docs/prototipos-de-tela/tela-login-autenticacao.png`                     | [WL-009](historias/WL-009-autenticacao-cliente-telefone.md)     | Login por telefone e verificação por código                       | RF14, RF15, RF16, RF17, RN01, RN02                   | QA, mobile, segurança, privacidade, SRE quando tocar configuração |

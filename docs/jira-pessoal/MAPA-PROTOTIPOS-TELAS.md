...
| `docs/prototipos-de-tela/tela-verificao-usuario-cliente-profissional.png` | [WL-025](historias/WL-025-autenticacao-propria-email-senha.md)  | Escolha/identificação de perfil para fluxo autenticado            | RF14, RF15, RF16, RF17, RN01, RN02                   | QA, mobile, segurança, privacidade                                |
